...
import { Code, Github, Handshake, Heart, MessageCircle, Shield, Star, Users } from 'lucide-react';
...
const Community = () => {
  const joinLinks = [
    {
      name: 'Discord',
      description:
        'Join our active Discord server for real-time discussions, help, and networking.',
      icon: MessageCircle,
  ...
  const guidelines = [
    ...
    },
    {
      ...
      title: 'No Spam',
      description:
        'Avoid excessive self-promotion and keep commercial content to designated channels.',
    },
  ];
            ...
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Connect with passionate Node.js developers, share knowledge, and grow your career
            ...
            <ScrollReveal>
              <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-12 text-center">
                ...
                <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
                  Join thousands of developers who are already part of our amazing community. Start
                  your journey today!
                </p>
