...
const Blog = () => {
  ...
  const featuredPost = {
    ...
    excerpt:
      'Learn advanced techniques for optimizing Node.js applications, from memory management to clustering and beyond.',
    author: 'Rajesh Patel',
    date: '2024-01-25',
    category: 'Tutorial',
  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'Deep dive into how Node.js event loop works and how to write efficient asynchronous code.',
      author: 'Priya Sharma',
      date: '2024-01-20',
      category: 'Tutorial',
      readTime: '8 min read',
            ...
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Stay updated with the latest tutorials, event recaps, and insights from the
                  Node.js ecosystem.
                </p>
              </div>
            </ScrollReveal>
        ...
        <section className="py-12 bg-slate-800/30">
          <div className="container mx-auto px-6">
            ...
            <ScrollReveal delay={200}>
              <Link className="group" to={`/blog/${featuredPost.id}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredPosts.map((post, index) => (
                <ScrollReveal key={post.id} delay={index * 100}>
                  <Link className="group" to={`/blog/${post.id}`}>
            ...
            <ScrollReveal>
              <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-12 text-center">
                ...
                <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
                  Subscribe to our newsletter and never miss the latest articles, tutorials, and
                  community updates.
                </p>
