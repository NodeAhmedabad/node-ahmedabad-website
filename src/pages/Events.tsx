...
import { Calendar, MapPin, Users, Clock, Filter, Search, Mic, Code, Lightbulb } from 'lucide-react';
            ...
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Join our regular meetups, workshops, and conferences to learn, network, and grow with fellow Node.js developers.
                </p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="container mx-auto px-6">
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-gray-300 text-lg">Don't miss out on these exciting learning opportunities</p>
              </div>
            </ScrollReveal>
          ...
          <div className="container mx-auto px-6">
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-gray-300 text-lg">Highlights from our previous successful events</p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
              <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-12 text-center">
                ...
                <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
                  Have an idea for a workshop or want to share your knowledge with the community? We'd love to hear from you!
                </p>
