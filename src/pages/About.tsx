...
import { Award, Heart, History, Shield, Target, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <main className="pt-20">
              ...
              <ScrollReveal>
                <div className="bg-slate-800 p-6 sm:p-8 rounded-2xl border border-gray-700">
                  ...
                  <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                    ...
                    high-quality learning opportunities, fostering collaboration, and supporting
                    career growth in the JavaScript ecosystem.
                  </p>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={200}>
                <div className="bg-slate-800 p-6 sm:p-8 rounded-2xl border border-gray-700">
                  ...
                  <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                    ...
                    developers of all levels can learn, grow, and contribute to the global
            ...
            <ScrollReveal>
              <div className="text-center mb-12 lg:mb-16">
                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
                    What started as informal meetups among friends has evolved into Gujarat's
                    largest Node.js community, hosting regular workshops, conferences, and
                    networking events that have helped hundreds of developers advance their careers.
                  </p>
                  <p className="text-gray-300 text-base sm:text-lg leading-relaxed">
                    Today, we're proud to be a platform where beginners find mentorship, experienced
                    developers share knowledge, and innovative ideas come to life through
                    collaboration.
                  </p>
                </div>
              </div>
                ...
                {timeline.map((item, index) => (
                  <ScrollReveal key={item.year} delay={index * 150}>
                    <div className="relative flex items-center mb-12 sm:mb-16 lg:mb-20 last:mb-0">
                      ...
                      <div
                        className={`flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br ${item.color} rounded-full flex items-center justify-center absolute left-8 sm:left-12 lg:left-16 -translate-x-1/2 z-10 shadow-lg border-4 border-slate-900`}
                      >
                        <item.icon
                          aria-hidden="true"
        ...
        <section
          ...
          className="py-12 sm:py-16 lg:py-20 bg-slate-800/30"
          role="region"
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
