...
import SinglePhotoModal from '@/components/gallery/SinglePhotoModal';
import cn from '@/lib/cn';

import type { GalleryItem, GalleryProps } from '@/components/gallery/types';
import type { Component } from '@/types';

/**
 * Gallery Card Component
 * Individual card with hover effects and overlay
 */
 ...
 * A simple, responsive gallery with lightbox functionality
 */

const GalleryGrid: Component<GalleryProps> = (props) => {
