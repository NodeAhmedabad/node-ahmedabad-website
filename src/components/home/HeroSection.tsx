...
import { ArrowRight, Play, Users, Calendar, Code2, Sparkles } from 'lucide-react';
            ...
            <div className="text-center lg:text-left">
              <ScrollReveal delay={200}>
                <div className="inline-flex items-center px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full mb-6">
                  ...
                  <span className="text-green-400 text-sm font-medium">Welcome to Node Ahmedabad</span>
                </div>
              </ScrollReveal>
